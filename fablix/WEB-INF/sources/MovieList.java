...
public class MovieList
{
        ...
        throws IOException
    {
        ...
        if(browseBy.equals("search"))
            this.movies = Search.createList(key);
        else
    ...
    public MovieList(ArrayList<Movie> movies, String key)
        throws IOException
    {

        this.browseBy = "AdvSearch";
        this.key = key;
        this.orderBy = "title";
        this.desc = false;
        this.page = 1;
    ...
    {
        String result =  "?browseBy=" + browseBy + 
                "&key=" + key  + 
                "&orderBy=" + orderBy + 
                "&desc=" + String.valueOf(desc)+ 
                "&page=" + String.valueOf(page)+ 
                "&ipp=" + String.valueOf(ipp);
        return result;
    }
}
